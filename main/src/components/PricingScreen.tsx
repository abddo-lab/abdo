...
interface Plan {
  ...
  price_yearly: number;
  features: string[];
  limits: { requests: number; projects: number };
  sort_order: number;
}
...
export default function PricingScreen({ user, token, onPlanSelected }: PricingScreenProps) {
  ...
  const fetchPlans = async () => {
    try {
      ...
      setPlans([
        { id: "starter", name: "Starter", description: "For individual developers getting started", price_monthly: 20, price_yearly: 192, features: ["500 requests/month", "Advanced models", "Email support", "5 projects", "Code review", "Basic analytics"], limits: { requests: 500, projects: 5 }, sort_order: 1 },
        { id: "pro", name: "Pro", description: "For professional developers who need more", price_monthly: 40, price_yearly: 384, features: ["2000 requests/month", "All models including GPT-4", "Priority support", "Unlimited projects", "Advanced code review", "Full analytics", "Custom instructions", "Team collaboration"], limits: { requests: 2000, projects: -1 }, sort_order: 2 },
        { id: "max", name: "Max", description: "For power users who need everything", price_monthly: 80, price_yearly: 768, features: ["Unlimited requests", "All models + early access", "Dedicated support", "Unlimited projects", "Advanced code review", "Full analytics + exports", "Custom instructions", "Team collaboration", "API access", "Custom integrations"], limits: { requests: -1, projects: -1 }, sort_order: 3 },
      ]);
    }
  };
