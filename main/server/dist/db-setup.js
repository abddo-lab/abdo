...
async function setup() {
    ...
    for (const plan of plans) {
        await pool.query(`INSERT INTO plans (id, name, description, price_monthly, price_yearly, features, limits, sort_order)
       ...
       ON CONFLICT (id) DO UPDATE SET
         ...
         sort_order = EXCLUDED.sort_order`, [plan.id, plan.name, plan.description, plan.price_monthly, plan.price_yearly, JSON.stringify(plan.features), JSON.stringify(plan.limits), plan.sort_order]);
    }
